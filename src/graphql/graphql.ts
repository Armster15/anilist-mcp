...
export const MediaListCollectionQueryDocument = new TypedDocumentString(`
    query MediaListCollectionQuery($username: String!, $type: MediaType!, $chunk: Int, $perChunk: Int, $sort: [MediaListSort]) {
  MediaListCollection(
    userName: $username
    type: $type
    chunk: $chunk
...
export const SearchQueryDocument = new TypedDocumentString(`
    query SearchQuery($page: Int = 1, $id: Int, $type: MediaType, $isAdult: Boolean = false, $search: String, $format: [MediaFormat], $status: MediaStatus, $countryOfOrigin: CountryCode, $source: MediaSource, $season: MediaSeason, $seasonYear: Int, $year: String, $onList: Boolean, $yearLesser: FuzzyDateInt, $yearGreater: FuzzyDateInt, $episodeLesser: Int, $episodeGreater: Int, $durationLesser: Int, $durationGreater: Int, $chapterLesser: Int, $chapterGreater: Int, $volumeLesser: Int, $volumeGreater: Int, $licensedBy: [Int], $isLicensed: Boolean, $genres: [String], $excludedGenres: [String], $tags: [String], $excludedTags: [String], $minimumTagRank: Int, $sort: [MediaSort] = [POPULARITY_DESC, SCORE_DESC], $perPage: Int = 20) {
